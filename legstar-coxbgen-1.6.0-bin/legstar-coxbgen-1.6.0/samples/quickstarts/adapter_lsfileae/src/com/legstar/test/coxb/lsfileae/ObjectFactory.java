 ...
 * generated in the com.legstar.test.coxb.lsfileae package. 
...
public class ObjectFactory {
    ...
    private final static QName _Dfhcommarea_QNAME = new QName("http://legstar.com/test/coxb/lsfileae", "Dfhcommarea");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.legstar.test.coxb.lsfileae
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://legstar.com/test/coxb/lsfileae", name = "Dfhcommarea")
